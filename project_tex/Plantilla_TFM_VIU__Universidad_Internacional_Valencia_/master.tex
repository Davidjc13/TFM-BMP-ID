...
\setlist[itemize]{itemsep=0pt, topsep=2pt, parsep=0pt, leftmargin=1.5em}
%----------------------------------------------------------
% PAQUETES:
% Language
...
\fancyhead[RO]{Máster en Inteligencia Artificial}
% Pie de pagina
...
% CAPITULO 1
\chapter{Resumen}\label{chapter:01}
\input{./files/cap01.tex}

% CAPITULO 2
\chapter{Introducción}\label{chapter:02}
\input{./files/cap02.tex}


% CAPITULO 3
\chapter{Estado del Arte}\label{chapter:03}
\input{./files/cap03.tex}

% CAPITULO 4
\chapter{Marco Teórico}\label{chapter:04}
\input{./files/cap04.tex}

% CAPITULO 5
\chapter{Metodología}\label{chapter:05}
\input{./files/cap05.tex}

% CAPITULO 6
\chapter{Resultados}\label{chapter:06}
\input{./files/cap06.tex}

% CAPITULO 7
\chapter{Conclusiones}\label{chapter:07}
\input{./files/cap07.tex}

% CAPITULO 8
\chapter{Limitaciones y trabajos futuros}\label{chapter:08}
